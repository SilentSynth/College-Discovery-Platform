  ...
  return (
    <aside className="space-y-5 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">Refine the discovery results by location, fees, and rating.</p>
      </div>

      <div className="space-y-3">
        <label className="text-sm font-medium text-slate-700">Search colleges</label>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="text-sm text-slate-600">{formatCurrency(filters.maxFees)}</span>
        </div>
        <input
          type="range"
          min={50000}
